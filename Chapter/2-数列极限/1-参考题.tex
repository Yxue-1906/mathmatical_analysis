...
\section{参考题}
 ...
 \subsection{第二组}
     ...
     \begin{exercise}
         将二项式系数$\binom{n}{0},\binom{n}{1},\cdots,\binom{n}{n}$的算数平均值和几何平均值分别记为$A_n$和$G_n$. 证明: (1)$\lim_{n\to\infty}\sqrt[n]{A_n}=2$,(2)$\lim_{n\to\infty}\sqrt[n]{G_n}=\sqrt{e}$.
     \end{exercise}
     \begin{solution}
         
        (1)利用$\sum\binom{n}{k}=2^n$, $\lim_{n\to\infty}\sqrt[n]{A_n}=\frac{2}{\displaystyle\lim_{n\to\infty}\sqrt[n]{n}}=2$

        (2)对待求式子取个对数就变成了上一题, 利用结论即可.
     \end{solution}
