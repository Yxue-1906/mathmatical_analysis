\section{确界的概念和确界存在定理}
 \subsection{练习题}
     ...
     \begin{exercise}
         求下列数集的上确界和下确界:
         \begin{tasks}(2)
             \task $\{x\in Q\,\lvert\, x>0\};$
             \task $\{y\,\lvert\, y=x^2,x\in(-\frac{1}{2},1)\};$
             \task $\left\{\left(1+\frac{1}{n}\right)^n \,\bigg\lvert\, n\in N_+\right\};$
             \task $\{ne^{-n}\,\lvert\, n\in N_+\};$
             \task $\{\arctan x \,\lvert\, x\in (-\infty,+\infty)\};$
             \task $\left\{(-1)^n+\frac{1}{n}(-1)^{n+1}\,\biggl\lvert\, n\in N_+\right\};$
             \task $\left\{1+n\sin\frac{n\pi}{2}\,\bigg\lvert\, n\in N_+\right\}$.
         \end{tasks}
     \end{exercise}
