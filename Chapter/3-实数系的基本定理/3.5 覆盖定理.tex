\section{覆盖定理}
 ...
 \subsection{思考题}
     ...
     \end{example}
     \begin{solution}
         例如$\{\mathcal{O}_i\}$是这样的:$\left\{\mathcal{O}\, \bigg|\, \left[\frac{1}{i+1},\frac{1}{i}\right],i\in \mathbb{N}_+\right\}\textstyle\bigcup[-1,0]$,很明显$\{\mathcal{O}_i\}$覆盖$\left[0,1\right]$,但是$\{\mathcal{O}_i\}$的任意有限子集都无法覆盖$\left[0,1\right]$.
     \end{solution}
